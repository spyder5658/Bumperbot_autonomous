...
class SimpleTfKinematics(Node):
    def __init__(self):
        ...
        self.get_transfrom_srv_ = self.create_service(GetTransform,"get_transfrom",self.getTransformCallback)
    ...
    def getTransformCallback(self,req,res):
        self.get_logger().info('Requested Transfrom between %s and %s'%(req.frame_id,req.child_frame_id))
